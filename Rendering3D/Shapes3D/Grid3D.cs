	...
	public class Grid3D : Entity3D
	{
		...
		private void CreateHorizontalLines()
		{
			...
			for (float i = -halfDimension; i < halfDimension + 1; i++)
				new Line3D(new Vector3D(-halfDimension, i, 0), new Vector3D(halfDimension, i, 0), Color.White);
		}
		...
		private void CreateVerticalLines()
		{
			...
			for (float i = -halfDimension; i < halfDimension + 1; i++)
				new Line3D(new Vector3D(i, halfDimension, 0), new Vector3D(i, -halfDimension, 0), Color.White);
		}
	}
}