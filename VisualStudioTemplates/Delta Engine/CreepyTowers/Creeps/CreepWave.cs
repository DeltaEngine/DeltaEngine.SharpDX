...
namespace $safeprojectname$.Creeps
{
	...
	{
		public CreepWave(float waitTime, float spawnInterval, string thingsToSpawn) : base(waitTime, 
			spawnInterval, thingsToSpawn)
		{
		...
		public CreepWave(Wave wave) : base(wave)
		{
			CreepSpawnList = new List<Object>();
			TotalCreepCount = 0;
			GetCreepSpawnList();
		...
		public List<Object> CreepSpawnList
		{
			get;
			private set;
		}

		public int TotalCreepCount
		{
			get;
			private set;
		}
