...
namespace $safeprojectname$.Creeps
{
	...
	{
		public CreepPropertiesXml(string contentName) : base(contentName)
		{
		}
		...
		{
			return new CreepData((CreepType)Enum.Parse(typeof(CreepType), 
				creep.GetAttributeValue("Type")), creep.GetAttributeValue("Name"), 
		...
		private readonly CreepData[] creepData = new CreepData[Enum.GetNames(typeof(CreepType)).Length];
