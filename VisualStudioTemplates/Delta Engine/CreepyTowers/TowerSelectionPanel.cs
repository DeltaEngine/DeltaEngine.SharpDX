...
namespace $safeprojectname$
{
	...
	{
		public TowerSelectionPanel(Point position, Manager manager)
		{
		...
		private void DrawAcidTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Acid, Names.TowerAcidConeJanitorHigh);
			Add(button);
		}
		...
		private Rectangle CalculateDrawArea(float angle)
		{
			...
			var drawArea = Rectangle.FromCenter(new Point(drawAreaCenterX, drawAreaCenterY), new 
				Size(0.05f));
			return drawArea;
		}
		...
		private void DrawFireTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Fire, Names.TowerFireCandlehulaHigh);
			Add(button);
		}
		...
		private void DrawIceTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Ice, Names.ModelIceTower);
			Add(button);
		}
		...
		private void DrawImpactTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Impact, Names.TowersImpactRangedKnightscalesHigh);
			Add(button);
		}
		...
		private void DrawSliceTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Blade, Names.ModelSliceTower);
			Add(button);
		}
		...
		private void DrawWaterTowerButton()
		{
			...
			AddClickEvent(button, Tower.TowerType.Water, Names.TowerWaterRangedWatersprayHigh);
			Add(button);
		}
