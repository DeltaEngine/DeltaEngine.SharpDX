...
namespace DeltaEngine.Rendering.Cameras.Tests
{
	public class FreeCameraTests : TestWithMocksOrVisually
	{
		...
		public void SetUpCamera()
		{
			...
			camera.Position = new Vector(0.0f, 5.0f, 5.0f);
		...
		public void Move()
		{
			camera.Move(Vector.UnitX, 1.0f);
			Assert.AreEqual(new Vector(1.0f, 5.0f, 5.0f), camera.Position);
		}
		...
		{
			camera.Rotate(Vector.UnitZ, 90.0f);
			camera.Move(Vector.UnitX, 1.0f);
			Assert.AreEqual(new Vector(0.0f, 6.0f, 5.0f), camera.Position);
		}
		...
		{
			camera.MoveUp(10.0f);
			Assert.AreEqual(new Vector(0.0f, 15.0f, 5.0f), camera.Position);
		}
		...
		public void MoveDown()
		{
			...
			Assert.AreEqual(new Vector(0.0f, -5.0f, 5.0f), camera.Position);
		}
		...
		public void MoveLeft()
		{
			...
			Assert.AreEqual(new Vector(-10.0f, 5.0f, 5.0f), camera.Position);
		}
		...
		public void MoveBackward()
		{
			...
			Assert.AreEqual(new Vector(0.0f, 5.0f, 15.0f), camera.Position);
		}
	}
}