...
namespace DeltaEngine.Rendering.Sprites.Tests
{
	public class AnimationTests : TestWithMocksOrVisually
	{
		...
		{
			Assert.Throws<ImageAnimation.NoImagesGivenNeedAtLeastOne>(() => new Material(
				Shader.Position2DUv, "ImageAnimationNoImages"));
		}
		...
		public void CreateAnimationWithEmptyTextures()
		{
			...
			Assert.Throws<ImageAnimation.NoImagesGivenNeedAtLeastOne>(() => new ImageAnimation(
				emptyImageList, 3));
		}
