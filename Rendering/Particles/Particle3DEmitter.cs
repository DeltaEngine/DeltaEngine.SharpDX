...
namespace DeltaEngine.Rendering.Particles
{
	...
	{
		protected Particle3DEmitter(ParticleEmitterData data, Vector spawnPosition)
		{
			EmitterData = data;
		...
		private void SpawnOneParticle()
		{
			...
			particles[freeSpot].SetStartVelocityRandomizedFromRange(EmitterData.StartVelocity.Start, EmitterData.StartVelocity.End);
			...
			particles[freeSpot].Vertices =
				Particle3D.GetVertices(EmitterData.Size.Start, EmitterData.Color.Start);
		}
		...
		protected abstract Vector GetParticleSpawnPosition();
		...
		public void SetForce(RangeGraph<Vector> forceRange)
		{
