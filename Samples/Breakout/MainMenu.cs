	...
	internal class MainMenu : Scene
	{
		...
		private void AddStartButton()
		{
			var startButton = new InteractiveButton(startGameTheme,
				new Rectangle(0.3f, ScreenSpace.Current.Bottom - 0.6f, 0.4f, 0.15f));
		...
		private void AddHowToPlay()
		{
			var howToButton = new InteractiveButton(howToPlayTheme,
				new Rectangle(0.3f, ScreenSpace.Current.Viewport.Bottom - 0.46f, 0.4f, 0.15f));
		...
		private void AddOptions()
		{
			var optionsButton = new InteractiveButton(optionsTheme,
				new Rectangle(0.3f, ScreenSpace.Current.Viewport.Bottom - 0.32f, 0.4f, 0.15f));
		...
		private class OptionSubmenu : Scene
		{
			...
			private void AddMusicOption()
			{
				...
				labelTheme.Label =
					new Theme.Appearance(new Material(Shader.Position2DColorUV, "MusicLabel"));
				...
				musicSlider.ValueChanged += val => { Settings.Current.MusicVolume = val / 100.0f; };
				Add(musicSlider);
			}
			...
			private void AddSoundOption()
			{
				var labelTheme = new Theme();
				labelTheme.Label =
					new Theme.Appearance(new Material(Shader.Position2DColorUV, "SoundLabel"));
				var label = new Label(labelTheme,
				...
				soundSlider.ValueChanged += val => { Settings.Current.SoundVolume = val / 100.0f; };
				Add(soundSlider);
			}
		...
		{
			var quitButton = new InteractiveButton(exitTheme,
				new Rectangle(0.3f, ScreenSpace.Current.Viewport.Bottom - 0.18f, 0.4f, 0.15f));
		...
		private void SetUpTheme()
		{
			...
			menuTheme = new Theme();
			menuTheme.Button =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "BackButtonDefault"));
			menuTheme.ButtonMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "BackButtonHover"));
			menuTheme.ButtonPressed =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "BackButtonHover"));
			menuTheme.Slider =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "SliderBackground"));
			menuTheme.SliderPointer =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "SliderDefault"));
			menuTheme.SliderPointerMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "SliderHover"));

			startGameTheme = new Theme();
			startGameTheme.Button =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "StartGameButtonDefault"));
			startGameTheme.ButtonMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "StartGameButtonHover"));
			startGameTheme.ButtonPressed =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "StartGameButtonHover"));

			optionsTheme = new Theme();
			optionsTheme.Button =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "OptionsButtonDefault"));
			optionsTheme.ButtonMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "OptionsButtonHover"));
			optionsTheme.ButtonPressed =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "OptionsButtonHover"));
			optionsTheme.Label =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "OptionsButtonDefault"));
			...
			exitTheme = new Theme();
			exitTheme.Button =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "ExitButtonDefault"));
			exitTheme.ButtonMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "ExitButtonHover"));
			exitTheme.ButtonPressed =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "ExitButtonHover"));

			howToPlayTheme = new Theme();
			howToPlayTheme.Button =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "HowToPlayButtonDefault"));
			howToPlayTheme.ButtonMouseover =
				new Theme.Appearance(new Material(Shader.Position2DColorUV, "HoWToPlayButtonHover"));
