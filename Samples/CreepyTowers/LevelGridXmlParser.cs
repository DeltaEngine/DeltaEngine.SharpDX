...
namespace CreepyTowers
{
	public class LevelGridXmlParser
	{
		...
		public ChangeableList<Tuple<int, int>> InteractablePointsList { get; private set; }
		public ChangeableList<List<Tuple<int, int>>> CreepPathsList { get; private set; }
		...
		private static WaypointObject GetWaypointsContent(XmlData item)
		{
			...
			return new WaypointObject { Type = type, Waypoint = tuple };
		}
		...
		public class WaypointObject
		{
			...
			public Tuple<int, int> Waypoint { get; set; }
		}
	}
}