...
namespace CreepyTowers.Tests.Simple2D
{
	public class StateChanger
	{
		...
		public static void MakeCreepResistantToType(Creep2D creep, TowerType type)
		{
			creep.state.SetVulnerability(type, CreepState.VulnerabilityType.Resistant);
		}

		public static void MakeCreepVulnerableToType(Creep2D creep, TowerType type)
		{
			creep.state.SetVulnerability(type, CreepState.VulnerabilityType.Vulnerable);
		}

		public static void MakeCreepImmuneToType(Creep2D creep, TowerType type)
		{
			creep.state.SetVulnerability(type, CreepState.VulnerabilityType.Immune);
		}

		public static void MakeCreepWeakToType(Creep2D creep, TowerType type)
		{
		...
		public static void MakeCreepHardBoiledToType(Creep2D creep, TowerType type)
		{
			creep.state.SetVulnerability(type, CreepState.VulnerabilityType.HardBoiled);
		}

		public static void MakeCreepNormalToType(Creep2D creep, TowerType type)
		{
