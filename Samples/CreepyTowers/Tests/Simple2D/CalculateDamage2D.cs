...
namespace CreepyTowers.Tests.Simple2D
{
	...
	{
		public float CalculateResistanceBasedOnStates(TowerType damageType, Creep2D creep)
		{
			var resistance = CheckResistanceBaseOnStateAndElementType(damageType, creep);
			return resistance;
		}

		private static float CheckResistanceBaseOnStateAndElementType(TowerType damageType,
			Creep2D creep)
		{
