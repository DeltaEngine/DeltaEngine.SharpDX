...
namespace CreepyTowers.Tests.Creeps
{
	public class CreepTests : TestWithMocksOrVisually
	{
		...
		private Creep CreateDefaultCreep()
		{
			...
			var creep = new Creep(position, Names.CreepCottonMummy, new CreepProperties
			{
				MaxHp = 100.0f,
				CurrentHp = 100.0f,
				Resistance = 1.0f,
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepIronTyrannosaurusAxe, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepGlass, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepsSandSandy, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepPaperPaperplane, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepsWoodScarecrow, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var creep = new Creep(Vector3D.Zero, Names.CreepPlasticBottledog, new CreepProperties());
			AddDefaultMovementComponent(creep);
			creep.Remove<MovementInGrid>();
		}
		...
		{
			var glassCreep = new Creep(Vector3D.Zero, Names.CreepGlass, new CreepProperties());
