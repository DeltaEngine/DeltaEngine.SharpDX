...
namespace DeltaEngine.Multimedia.VideoStreams.Avi
{
	...
	public class AviInterop
	{
		...
		public static extern uint AVIFileOpen(ref int filePtr, String filepath, int uMode,
			int pclsidHandler);

		[DllImport("avifil32.dll")]
		public static extern uint AVIFileGetStream(int filePtr, out IntPtr streamPtr, int fccType,
			int lParam);
		...
		[DllImport("avifil32.dll")]
		public static extern uint AVIStreamInfo(IntPtr streamPtr, ref StreamInfo psi, int lSize);
		...
		[DllImport("avifil32.dll")]
		public static extern uint AVIFileRelease(int filePtr);

		[DllImport("avifil32.dll")]
		public static extern void AVIFileExit();

		[DllImport("avifil32.dll")]
		public static extern uint AVIStreamRead(IntPtr streamPtr, int lStart, int lSamples,
